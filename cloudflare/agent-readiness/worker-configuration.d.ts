/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/agent-readiness/wrangler.jsonc cloudflare/agent-readiness/worker-configuration.d.ts` (hash: 3d3fdd145760295159fc1eac24135779)
