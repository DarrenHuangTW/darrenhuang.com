...
function englishLlmsDocument(
  ...
  return [
    ...
    `- [Saved Facebook notes](${notes.canonicalUrl}): ${noteCount} English notes translated from the saved Chinese Facebook archive.`,
    ...
    `- [Web Stories](${stories.canonicalUrl}): Two English Web Stories with translated page-by-page transcripts and AMP artifacts.`,
    '',
    '## Site information',
    '',
    ...
    '## Programmatic interfaces',
    '',
    `- [English content metadata](${siteAssetUrl('/api/en/content.json')}): English article and saved-note metadata with Markdown URLs.`,
